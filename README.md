...
<table align="center" width="100%">
  ...
  <tr>
    <td colspan="4" align="center">
      <b>ReSTIR DI. Materias Lambert + GGX, 5 new x MIS samples (Area Lights & GGX), spatial re-use of 12 samples, 4 frames temporal accumulation. 0.86 rays per pixel (average). PDF not recomputed WIP</b>
    </td>
  </tr>
</table>
